...
?eclat
itemFrequencyPlot (Groceries,topN = 15,type="absolute") #number
itemFrequencyPlot(Groceries, topN = 10, type='relative')
abline(h=0.2)

rules <- arules::apriori(Groceries, parameter = list(supp = 0.005, conf = 0.5))#0.5 means 50% times bought together
rules
