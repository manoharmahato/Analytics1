...
library(gsheet)
url='https://docs.google.com/spreadsheets/d/1h7HU0X_Q4T5h5D1Q36qoK40Tplz94x_HZYHOJJC_edU/edit#gid=1941519952'
...
Mer_Sales = read.csv("./data/CART1.csv")
Mer_Sales = read.csv(file.choose())
